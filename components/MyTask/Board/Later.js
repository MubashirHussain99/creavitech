  ...
  return (
    <div className="ml-3 md:min-w-[23%] min-w-[22%] ">
      ...
      <div className="h-[650px]  border-2 border-gray-200 ">
        ...
        <div className="w-[97%] ml-1 h-[100px] hover:border border border-white rounded-2xl hover:border-gray-300 text-white hover:text-gray-500">
